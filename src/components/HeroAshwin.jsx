...
const PROFILE_IMAGE = profile.photo;
const PROFILE_IMAGE_ALT = profile.photoAlt;
    ...
    >
      ...
      >
          ...
          >
            ...
            <div>
              ...
              >
                {profile.company}
                <br />
                {CURRENT_ROLE?.period ?? profile.experienceYears}
              </p>
            </div>
          </m.div>
        ...
        >
          ...
          >
            <div
              className="hero-portrait-flip"
              onMouseEnter={() => setPhotoHover(true)}
              onMouseLeave={() => setPhotoHover(false)}
            >
              <div className={`hero-portrait-flip-inner${photoHover ? " is-flipped" : ""}`}>
                <div className="hero-portrait-flip-face hero-portrait-flip-front">
                  <img
                    src={PROFILE_IMAGE}
                    ...
                    decoding="async"
                  />
                  <div className="hero-portrait-flip-fade" />
                </div>
                <div className="hero-portrait-flip-face hero-portrait-flip-back">
                  <img
                    src={PROFILE_IMAGE_ALT}
                    alt=""
                    aria-hidden
                    width={800}
                    height={1734}
